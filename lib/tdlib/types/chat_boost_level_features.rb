module TD::Types
  ...
  # @attr accent_color_count [Integer] Number of custom colors for background of empty chat photo, replies to
  #   messages and link previews.
  # @attr can_set_background_custom_emoji [Boolean] True, if custom emoji for reply header and link preview
  ...
  #   chat.
  # @attr can_recognize_speech [Boolean] True, if speech recognition can be used for video note and voice note
