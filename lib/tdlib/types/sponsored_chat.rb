module TD::Types
  ...
  # @attr sponsor_info [TD::Types::String] Additional optional information about the sponsor to be shown along with
  #   the chat.
  # @attr additional_info [TD::Types::String] If non-empty, additional information about the sponsored chat to be
