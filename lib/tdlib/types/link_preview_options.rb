module TD::Types
  ...
  # @attr force_small_media [Boolean] True, if shown media preview must be small; ignored in secret chats or if the
  #   URL isn't explicitly specified.
  # @attr force_large_media [Boolean] True, if shown media preview must be large; ignored in secret chats or if the
  #   URL isn't explicitly specified.
  # @attr show_above_text [Boolean] True, if link preview must be shown above message text; otherwise, the link
