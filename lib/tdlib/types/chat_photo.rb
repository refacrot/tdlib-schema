module TD::Types
  ...
  # @attr animation [TD::Types::AnimatedChatPhoto, nil] A big (up to 1280x1280) animated variant of the photo in
  #   MPEG4 format; may be null.
  # @attr small_animation [TD::Types::AnimatedChatPhoto, nil] A small (160x160) animated variant of the photo in
  #   MPEG4 format; may be null even if the big animation is available.
