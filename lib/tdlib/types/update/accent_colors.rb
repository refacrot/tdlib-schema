module TD::Types
  ...
  #
  # @attr colors [Array<TD::Types::AccentColor>] Information about supported colors; colors with identifiers 0 (red),
  #   1 (orange), 2 (purple/violet), 3 (green), 4 (cyan), 5 (blue), 6 (pink) must always be supported and aren't included
  #   in the list.
