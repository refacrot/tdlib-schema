module TD::Types
  ...
  # @attr conversion [TD::Types::String] If the conversion is "#url#" than original_path contains an HTTP/HTTPS URL
  #   of a file that must be downloaded by the application.
