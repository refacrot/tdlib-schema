module TD::Types
  ...
  #   The updates are sent only after the group call is received through getGroupCall and only if the call is joined
  #   or being joined.
  #
  # @attr group_call_id [Integer] Identifier of the group call.
  # @attr participant [TD::Types::GroupCallParticipant] New data about the participant.
