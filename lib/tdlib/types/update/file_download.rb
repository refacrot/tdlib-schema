module TD::Types
  ...
  # @attr complete_date [Integer] Point in time (Unix timestamp) when the file downloading was completed; 0 if the
  #   file downloading isn't completed.
  # @attr is_paused [Boolean] True, if downloading of the file is paused.
  # @attr counts [TD::Types::DownloadedFileCounts] New number of being downloaded and recently downloaded files
  #   found.
