module TD::Types
  ...
  # @attr chat_is_channel [Boolean] True, if the chat must be a channel; otherwise, a basic group or a supergroup
  #   chat is shared.
  # @attr restrict_chat_is_forum [Boolean] True, if the chat must or must not be a forum supergroup.
  # @attr chat_is_forum [Boolean] True, if the chat must be a forum supergroup; otherwise, the chat must not be a
  #   forum supergroup.
  ...
  # @attr user_administrator_rights [TD::Types::ChatAdministratorRights, nil] Expected user administrator rights in
