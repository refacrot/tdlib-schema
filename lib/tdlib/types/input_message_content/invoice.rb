module TD::Types
  ...
  # @attr provider_token [TD::Types::String, nil] Payment provider token; may be empty for payments in Telegram
  #   Stars.
  # @attr provider_data [TD::Types::String] JSON-encoded data about the invoice, which will be shared with the
  #   payment provider.
  ...
  # @attr paid_media [TD::Types::InputPaidMedia] The content of paid media attached to the invoice; pass null if
  #   none.
