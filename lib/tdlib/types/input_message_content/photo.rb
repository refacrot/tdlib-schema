module TD::Types
  ...
  # @attr show_caption_above_media [Boolean] True, if the caption must be shown above the photo; otherwise, the
  #   caption must be shown below the photo; not supported in secret chats.
  # @attr self_destruct_type [TD::Types::MessageSelfDestructType] Photo self-destruct type; pass null if none;
  #   private chats only.
