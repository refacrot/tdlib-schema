module TD::Types
  ...
  # @attr live_period [Integer] Period for which the location can be updated, in seconds; must be between 60 and
  #   86400 for a temporary live location, 0x7FFFFFFF for permanent live location, and 0 otherwise.
