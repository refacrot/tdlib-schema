module TD::Types
  ...
  #   If positive, then the program can't be connected using connectAffiliateProgram, but active connections will
  #   work until the date.
  # @attr daily_revenue_per_user_amount [TD::Types::StarAmount] The amount of daily revenue per user in Telegram
  #   Stars of the bot that created the affiliate program.
