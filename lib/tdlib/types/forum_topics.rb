module TD::Types
  ...
  # @attr next_offset_forum_topic_id [Integer] Offset forum topic identifier for the next getForumTopics request.
  class ForumTopics < Base
    ...
    attribute :next_offset_forum_topic_id, TD::Types::Coercible::Integer
  end
end
