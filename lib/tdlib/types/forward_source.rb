module TD::Types
  ...
  # @attr sender_id [TD::Types::MessageSender, nil] Identifier of the sender of the message; may be null if unknown
  ...
  # @attr is_outgoing [Boolean] True, if the message that was forwarded is outgoing; always false if sender is
  #   unknown.
