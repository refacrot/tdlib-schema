module TD::Types
  ...
  # @attr background_fill [TD::Types::BackgroundFill] The fill to be used as background for the sticker; rotation
  #   angle in {TD::Types::BackgroundFill::Gradient} isn't supported.
