module TD::Types
  ...
  #
  # @attr personal_photo [TD::Types::ChatPhoto, nil] User profile photo set by the current user for the contact; may
  #   be null.
  ...
  # @attr has_sponsored_messages_enabled [Boolean] True, if the user always enabled sponsored messages; known only
  ...
  # @attr bot_verification [TD::Types::BotVerification, nil] Information about verification status of the user
  ...
  #   manually.
  # @attr first_profile_audio [TD::Types::Audio, nil] The first audio file added to the user's profile; may be null
  #   if none.
  # @attr rating [TD::Types::UserRating, nil] The current rating of the user; may be null if none.
  # @attr pending_rating [TD::Types::UserRating, nil] The rating of the user after the next change; may be null if
  #   the user isn't the current user or there are no pending rating changes.
  # @attr pending_rating_date [Integer] Unix timestamp when rating of the user will change to pending_rating; 0 if
  #   the user isn't the current user or there are no pending rating changes.
  ...
  # @attr bot_info [TD::Types::BotInfo, nil] For bots, information about the bot; may be null if the user isn't a
  #   bot.
