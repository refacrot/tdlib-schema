module TD::Types
  ...
  # @attr can_reuse [Boolean] True, if the user has already paid for the subscription and can use
  #   joinChatByInviteLink to join the subscribed chat again.
  # @attr form_id [Integer] Identifier of the payment form to use for subscription payment; 0 if the subscription
  #   can't be paid.
