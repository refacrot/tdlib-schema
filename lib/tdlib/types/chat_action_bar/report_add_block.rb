module TD::Types
  ...
  #   blocked using the method setMessageSenderBlockList, or the other user can be added to the contact list using the
  #   method addContact.
  ...
  # @attr account_info [TD::Types::AccountInfo, nil] Basic information about the other user in the chat; may be null
  #   if unknown.
