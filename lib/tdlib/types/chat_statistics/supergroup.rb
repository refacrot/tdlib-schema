module TD::Types
  ...
  # @attr top_senders [Array<TD::Types::ChatStatisticsMessageSenderInfo>] List of users sent most messages in the
  #   last week.
  ...
  # @attr top_inviters [Array<TD::Types::ChatStatisticsInviterInfo>] List of most active inviters of new members in
  #   the last week.
