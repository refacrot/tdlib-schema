module TD::Types
  ...
  # @attr link_preview_options [TD::Types::LinkPreviewOptions, nil] Options which were used for generation of the
  #   link preview; may be null if default options were used.
