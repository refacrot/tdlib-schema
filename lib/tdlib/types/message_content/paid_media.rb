module TD::Types
  ...
  #
  # @attr star_count [Integer] Number of Telegram Stars needed to buy access to the media in the message.
  # @attr media [Array<TD::Types::PaidMedia>] Information about the media.
  # @attr caption [TD::Types::FormattedText] Media caption.
  # @attr show_caption_above_media [Boolean] True, if the caption must be shown above the media; otherwise, the
