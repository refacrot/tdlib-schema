module TD::Types
  ...
  #   Use telegramPaymentPurposePremiumGiveaway, storePaymentPurposePremiumGiveaway,
  #   telegramPaymentPurposeStarGiveaway, or storePaymentPurposeStarGiveaway to create a giveaway.
  #
  # @attr star_count [Integer] Number of Telegram Stars that will be shared by winners of the giveaway; 0 for
