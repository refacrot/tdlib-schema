module TD::Types
  ...
  # @attr sender_id [TD::Types::MessageSender, nil] Sender of the gift; may be null for outgoing messages about
  ...
  #   gift.
  # @attr was_converted [Boolean] True, if the gift was converted to Telegram Stars; only for the receiver of the
  #   gift.
