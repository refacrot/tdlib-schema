module TD::Types
  ...
  #   An {TD::Types::Update::SupergroupFullInfo} update is not triggered when value of this field changes, but both
  #   new and old values are non-zero.
  ...
  # @attr can_get_star_revenue_statistics [Boolean] True, if the supergroup or channel Telegram Star revenue
  #   statistics are available.
  # @attr can_send_gift [Boolean] True, if the user can send a gift to the supergroup or channel using sendGift or
  #   transferGift.
  # @attr can_toggle_aggressive_anti_spam [Boolean] True, if aggressive anti-spam checks can be enabled or disabled
  #   in the supergroup.
  ...
  # @attr unrestrict_boost_count [Integer] Number of times the supergroup must be boosted by a user to ignore slow
  #   mode and chat permission restrictions; 0 if unspecified.
  # @attr outgoing_paid_message_star_count [Integer] Number of Telegram Stars that must be paid by the current user
  #   for each sent message to the supergroup.
  ...
  # @attr bot_verification [TD::Types::BotVerification, nil] Information about verification status of the supergroup
  ...
  # @attr upgraded_from_basic_group_id [Integer] Identifier of the basic group from which supergroup was upgraded; 0
  #   if none.
