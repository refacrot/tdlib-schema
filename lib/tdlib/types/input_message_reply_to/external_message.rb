module TD::Types
  ...
  #   A message can be replied in another chat or forum topic only if
  ...
  # @attr checklist_task_id [Integer] Identifier of the checklist task in the message to be replied; pass 0 to reply
