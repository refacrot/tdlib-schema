module TD::Types
  ...
  # @attr is_password_pending [Boolean] True, if a 2-step verification password is needed to complete authorization
  #   of the session.
  ...
  # @attr type [TD::Types::SessionType] Session type based on the system and application version, which can be used
  ...
  #   the application.
  # @attr system_version [TD::Types::String] Version of the operating system the application has been run or is
  ...
  # @attr location [TD::Types::String] A human-readable description of the location from which the session was
