module TD::Types
  ...
  # @attr use_default_mute_stories [Boolean] If true, story notifications are received only for the first 5 chats
  #   from {TD::Types::TopChatCategory::Users} regardless of the value of mute_stories.
  ...
  # @attr disable_mention_notifications [Boolean] True, if notifications for messages with mentions will be created
