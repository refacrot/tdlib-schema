module TD::Types
  ...
  # @attr default_sell_star_count [Integer] Number of Telegram Stars that can be claimed by the receiver instead of
  #   the regular gift by default.
  ...
  #   isn't possible.
  # @attr upgrade_variant_count [Integer] Number of unique gift variants that are available for the upgraded gift; 0
  #   if unknown.
  ...
  # @attr auction_info [TD::Types::GiftAuction, nil] Information about the auction on which the gift can be
  ...
  # @attr overall_limits [TD::Types::GiftPurchaseLimits, nil] Number of times the gift can be purchased all users;
  #   may be null if not limited.
  # @attr background [TD::Types::GiftBackground] Background of the gift.
  # @attr first_send_date [Integer] Point in time (Unix timestamp) when the gift was send for the first time; for
  #   sold out gifts only.
