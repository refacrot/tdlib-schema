module TD::Types
  ...
  # @attr phone_number_country_code [TD::Types::String, nil] A two-letter ISO 3166-1 alpha-2 country code based on the
  #   phone number of the user; may be empty if unknown.
