module TD::Types
  ...
  # @attr initial_sale_date [Integer] Point in time (Unix timestamp) when the corresponding regular gift was
  ...
  # @attr last_sale_date [Integer] Point in time (Unix timestamp) when the upgraded gift was purchased last time; 0
  #   if never.
  ...
  # @attr minimum_price [Integer] The current minimum price of gifts upgraded from the same gift; in the smallest
  #   units of the currency; 0 if there are no such gifts.
  ...
  # @attr fragment_url [TD::Types::String, nil] The HTTPS link to the Fragment for the gift; may be empty if there
  #   are no such gifts being sold on Fragment.
