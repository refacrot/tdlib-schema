module TD::Types
  ...
  #   If the user is found, then call createPrivateChat and open user's profile information screen or the chat
  #   itself.
  ...
  # @attr open_profile [Boolean] True, if user's profile information screen must be opened; otherwise, the chat
