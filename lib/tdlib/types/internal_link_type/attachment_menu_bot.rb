module TD::Types
  ...
  #   If the bot isn't added to attachment menu, then show a disclaimer about Mini Apps being third-party
  #   applications, ask the user to accept their Terms of service and confirm adding the bot to side and attachment menu.
