module TD::Types
  ...
  #   Call searchPublicChat with the given bot username, check that the user is a bot.
  #   If the bot is restricted for the current user, then show an error message.
  #   Otherwise, call searchWebApp with the received bot and the given web_app_short_name.
