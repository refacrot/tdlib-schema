module TD::Types
  # The link can be used to login the current user on another device, but it must be scanned from QR-code using
  #   in-app camera.
  ...
  class InternalLinkType::QrCodeAuthentication < InternalLinkType
  end
end
