module TD::Types
  ...
  #   If the chat is found, then call getChatBoostStatus and getAvailableChatBoostSlots to get the current boost
  #   status and check whether the chat can be boosted.
