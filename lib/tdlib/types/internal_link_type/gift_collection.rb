module TD::Types
  ...
  #   Call searchPublicChat with the given username, then call getReceivedGifts with the received gift owner
  #   identifier and the given collection identifier, then show the collection if received.
  #
