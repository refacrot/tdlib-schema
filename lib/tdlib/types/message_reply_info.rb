module TD::Types
  ...
  # @attr recent_replier_ids [Array<TD::Types::MessageSender>] Identifiers of at most 3 recent repliers to the
  #   message; available in channels with a discussion supergroup.
